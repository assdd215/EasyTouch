...
public class MenuViewManager_back implements OnMenuHolderEventListener{
    ...
    public MenuViewManager_back(Context context){
    ...
    private List<FloatMenuItem> initMenuItems(){
        ...
        modelList.add(model);
        menuView.addMenuItem(context.getString(R.string.menu_tel), context.getResources().getDrawable(R.drawable.menu_tel), functionItemListener,model.getType());
        ...
        model.setPosition(modelList.size());
        modelList.add(model);
        menuView.addMenuItem(context.getString(R.string.menu_message), context.getResources().getDrawable(R.drawable.menu_message), functionItemListener,model.getType());
        ...
        model.setPosition(modelList.size());
        modelList.add(model);
        menuView.addMenuItem(String.valueOf(context.getString(R.string.menu_camera)), context.getResources().getDrawable(R.drawable.menu_camera), functionItemListener,model.getType());
        ...
        if (screenShotUtil.isSupportScreenshot()){
            ...
            model.setPosition(modelList.size());
            modelList.add(model);
            menuView.addMenuItem(context.getString(R.string.menu_screenshot), context.getResources().getDrawable(R.drawable.menu_cut_enable), functionItemListener,model.getType());
        }
        ...
        model.setPosition(modelList.size());
        modelList.add(model);
        menuView.addMenuItem(context.getString(R.string.menu_bluetooth), context.getResources().getDrawable(R.drawable.menu_blutooth_off), functionItemListener,model.getType());
        ...
        model.setPosition(modelList.size());
        modelList.add(model);
        menuView.addMenuItem(context.getString(R.string.menu_wifi), context.getResources().getDrawable(R.drawable.menu_wifi_off), functionItemListener,model.getType());
        ...
        model.setPosition(modelList.size());
        modelList.add(model);
        menuView.addMenuItem(context.getString(R.string.menu_search), context.getResources().getDrawable(R.drawable.menu_browser), functionItemListener,model.getType());
        ...
        if (cameraUtil.isSupportFlash()){
            ...
            model.setPosition(modelList.size());
            modelList.add(model);
            menuView.addMenuItem(context.getString(R.string.menu_light), context.getResources().getDrawable(R.drawable.menu_flashlight_off), functionItemListener,model.getType());
        }
        ...
        model.setPosition(modelList.size());
        modelList.add(model);
        menuView.addMenuItem(context.getString(R.string.menu_home), context.getResources().getDrawable(R.drawable.menu_home), functionItemListener,model.getType());
        ...
        model.setPosition(modelList.size());
        modelList.add(model);
        menuView.addMenuItem(context.getString(R.string.menu_boost), context.getResources().getDrawable(R.drawable.menu_boost), functionItemListener,model.getType());
        ...
        for (FloatMenuItem item:modelList){
            switch (item.getType()){
                case FloatMenuItem.TYPE_FUNCTION:
                    menuView.addMenuItem(context.getString(Integer.parseInt(item.getItemTitleId())),context.getResources().getDrawable(item.getIconId()),functionItemListener,FloatMenuItem.TYPE_FUNCTION);
                    break;
    ...
    private void addCommonlyApp(ResolveInfo info){
        ...
        menuView.addMenuItem(info.loadLabel(packageManager).toString(), info.loadIcon(packageManager), new View.OnClickListener() {
            @Override
...
//        menuView.setDeleteVisible(false);
    ...
    private void changeItemIcon(String itemTitle,int iconId){
        ...
        List<ItemModel> itemModels = menuView.findModelsByTitle(itemTitle);
    ...
    private void buildChooseAllAppsDialog(final int position){
        ...
        adapter.setOnItemClickListener(new DialogItemAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view) {
                ...
                menuView.updateItemByPosition(commonAppInfo.getLabel(),commonAppInfo.getIcon(),null,FloatMenuItem.TYPE_SHORTCUT,position);
                dialog.cancel();
                dialog.dismiss();
                //数据更新
                ...
                ItemModel itemModel = menuView.findViewByPosition(position);
